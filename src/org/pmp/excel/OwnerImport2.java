 ...
 * @update TODO
 */
public class OwnerImport2 {

    //~ Static Fields ==================================================================================================
    private static Logger logger = Logger.getLogger(OwnerImport2.class.getName());
	...
	try {
	    ...
	    /* get used services from spring context */
            ...
            IBuildingService buildingService = (IBuildingService)SpringContextUtil.getBean("buildingSevrice");
	        ...
	        if(!OwnerValidate2.isRight(list)){
	            ...
	            if(house==null){
	        	logger.error("house instance is null");
	        	hasError = true;
	        	continue;
	            }
