	...
	<body>
	      <div class="window_content">
	            <form id="form" name="form" action="addZone" method="post" enctype="multipart/form-data">
	                <div class="rowStyle">
	                   <div><span >场地名称：</span><span><input name="zone.zoneName" type="text" class="textbox" id="project.proName" /></span></div>
	                </div>
	                <div class="rowStyle">
	                              <div>
		                              <span >所在小区：</span>
	                ...
	                <div class="rowStyle">
	                   <div><span >类型：</span><span><input name="zone.zoneType" type="text" class="textbox" id="project.proName" /></span></div>
	                </div>
	                <div class="rowStyle">
		                   <div>
		                       <span >图片：</span>
