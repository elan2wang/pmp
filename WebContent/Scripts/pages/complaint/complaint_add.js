...
function getOwner(){
	...
	$.ajax({
		...
		dataType: "json",
		success: function(data){
			$('#compPerson').val(data.ownerName);
			$('#compTel').val(data.contactPhone);
		}
	});
}
...
function formchk(){
	...
	obj4=document.getElementById("compPerson");
	obj5=document.getElementById("compTel");
	obj6=document.getElementById("complaint.compTime");
	var isotherPatten=/^\d*$/;
