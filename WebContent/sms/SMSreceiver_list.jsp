...
<script type="text/javascript" src="../Scripts/pages/sms/SMSreceiver_list.js"></script>
</head>
<body>
<div class="wrap">      
	   <ul class="nav">
       ...
       <div class="content" style="height:380px">
           ...
           <div class="innercontent" style="height:380px">
             <iframe id="SMSowner_Frame" name="SMSowner_Frame" frameborder="0" scrolling="auto" width="100%" height="380"  >
              </iframe>
           </div>
       </div>
 </div>
