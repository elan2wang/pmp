...
<!-- pop up windows -->
<div id="cfEdit" class="easyui-window" title="物业费修改" iconCls="icon-save" style="width:400px;height:270px;padding:5px;" closed="true" collapsible="false" minimizable="false" maximizable="false"></div>
