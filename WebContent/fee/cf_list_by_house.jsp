...
<!-- pop up windows -->
<div id="cfInput" class="easyui-window" title="物业费录入" iconCls="icon-save" style="width:350px;height:370px;padding:5px;" closed="true" collapsible="false" minimizable="false" maximizable="false"></div>
