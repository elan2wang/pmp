...
<table id="cf_list">
   ...
   <tr>
     <td>${status.count }</td><td>${fee.house.building.project.proName }</td><td>${fee.house.houseNum }</td><td>${fee.owner.ownerName }</td><td>${fee.state }</td><td>${fee.oughtMoney }</td><td>${fee.fetchMoney }</td><td>${fee.fetchDate }</td>
   </tr>
   </c:forEach>
   </tbody>
</table>
