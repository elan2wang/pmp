...
<script type="text/javascript" src="../Scripts/pages/cms/house_import.js"></script>
...
<br/>
<h2>请选择上传的文件</h2>
<input type="file" id="refFile" size="25" name="refFile" /><input type="button" value="导入" onclick="new_house_import()">
