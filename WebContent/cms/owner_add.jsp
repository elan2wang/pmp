...
<form id="form1" name="form1" action="saveOwner" method="post">
          ...
          <tr>
            <td align="center" valign="middle"><table border="0" align="center" cellpadding="0" cellspacing="0" class="table1">
              <tr>
                ...
                <td width="220" colspan="2" align="left" valign="middle"><input name="owner.ownerName" type="text" class="textbox" id="owner.ownerName"  /></td>
              ...
              <tr>
                ...
                <td colspan="2" align="center" valign="middle"><input name="owner.birthday" type="text" class="textbox" id="owner.birthday" readonly="readonly"  style="cursor:pointer;" onFocus="WdatePicker()" /></td>
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"><input name="owner.organization" type="text" class="textbox" id="owner.organization" /></td>
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"><input name="owner.homePhone" type="text" class="textbox" id="owner.homePhone"  /></td>
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"><input name="owner.getTime" type="text" class="textbox" id="owner.getTime" readonly="readonly"  style="cursor:pointer;" onFocus="WdatePicker()" /></td>
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"><input name="owner.inTime" type="text" class="textbox" id="owner.inTime" readonly="readonly"  style="cursor:pointer;" onFocus="WdatePicker()" /></td>
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"><input name="owner.carNum" type="text" class="textbox" id="owner.carNum"  /></td>
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"><input name="owner.storeroom" type="text" class="textbox" id="owner.storeroom"  /></td>
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"><table border="0" cellpadding="0" cellspacing="0" class="pinfen">
                  <tr>
                    <td align="center" valign="middle"><input type="radio" name="owner.useStyle" id="radio" value="常住" checked /></td>
                    <td width="40" align="left" valign="middle">常住</td>
                    <td align="center" valign="middle"><input type="radio" name="owner.useStyle" id="radio2" value="租住"  /></td>
                    <td width="40" align="left" valign="middle">租住</td>
                    <td align="center" valign="middle"><input type="radio" name="owner.useStyle" id="radio3" value="暂住"  /></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center" valign="middle"><table border="0" align="center" cellpadding="0" cellspacing="0" class="table1">
              ...
              <tr>
                <td height="30" align="center" valign="middle"><input name="memberName" type="text" class="textbox" id="memberName" style="width:80px;"  /></td>
                <td align="center" valign="middle"><input name="memberRelation" type="text" class="textbox" id="memberRelation" style="width:50px;"  /></td>
                <td align="center" valign="middle"><input name="cardNum" type="text" class="textbox" id="cardNum" style="width:200px;"   /></td>
                <td colspan="2" align="center" valign="middle"><input name="phoneNum" type="text" class="textbox" id="phoneNum" style="width:180px;"  /></td>
              </tr>
              <tr>
                <td height="30" align="center" valign="middle"><input name="memberName" type="text" class="textbox" id="memberName" style="width:80px;"  /></td>
                <td align="center" valign="middle"><input name="memberRelation" type="text" class="textbox" id="memberRelation" style="width:50px;"  /></td>
              ...
              <tr>
                ...
                <td height="30" align="center" valign="middle"><input name="owner.otherAddress" type="text" class="textbox" id="owner.otherAddress" style="width:200px;"   /></td>
                <td width="70" height="30" align="center" valign="middle">邮政编码：</td>
                <td align="center" valign="middle"><input name="owner.otherPostcode" type="text" class="textbox" id="owner.otherPostcode" style="width:80px;"  /></td>
              </tr>
              <tr>
                <td height="30" colspan="2" align="center" valign="middle">紧急联系人：</td>
                <td height="30" align="center" valign="middle"><input name="owner.emergencyContact" type="text" class="textbox" id="owner.emergencyContact" style="width:200px;"   /></td>
                <td height="30" align="center" valign="middle">联系电话：</td>
                <td align="center" valign="middle"><input name="owner.emergencyPhone" type="text" class="textbox" id="owner.emergencyPhone" style="width:80px;"  /></td>
              </tr>
              <tr>
