...
<body>
<form id="form2" method="post" action="updateCompany" onsubmit="return FormCheck();">
                       <div class="rowStyle" style="display:none">
                          <div><span >公司编号：</span><span><input name="company.comId" type="text" class="textbox" id="company.comId2" value="${company.comId }"/></span></div>
                       </div>
                       <div class="rowStyle">
                          <div><span >公司名称：</span><span><input name="company.comName" type="text" class="textbox" id="company.comName2" value="${company.comName }" readOnly/></span></div>
                       </div>
                       <div class="rowStyle">
                          <div ><span >公司法人：</span><span><input name="company.comLegal" type="text" class="textbox" id="company.comLegal2" value="${company.comLegal }"/></span></div>
                       </div>
                       <div class="rowStyle">
                          <div><span >公司电话：</span><span><input name="company.comPhone" type="text" class="textbox" id="company.comPhone2" value="${company.comPhone }"/></span></div>
                       </div>
                       <div class="rowStyle">
                       ...
                       <div class="rowStyle">
                          <div><span >公司地址：</span><span><input name="company.comAddress" type="text" class="textbox" id="company.comAddress2" value="${company.comAddress }"/></span></div>
                       </div>
                       <div class="rowStyle">
