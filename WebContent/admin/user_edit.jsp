...
<form name="form" id="form" action="editUser" method="post">
		<input type="hidden" name="user.userId" id="user.userId" value='${ugr.tbUser.userId }'/>
         <div class="rowStyle">
             <div><span >真实姓名:</span><span><input type="text" name="user.realname"  value='${ugr.tbUser.realname }' id="user.realname" readOnly/></span></div>
         </div>
         <div class="rowStyle">
             <div><span >用&nbsp;户&nbsp;名:</span><span><input type="text" name="user.username"  value='${ugr.tbUser.username }' id="user.username" readOnly/></span></div>
         </div>
         <div class="rowStyle">
             <div><span >手机号码:</span><span><input type="text" name="user.mobile" value='${ugr.tbUser.mobile }' id="user.mobile"/></span></div>
         </div>
         <div class="rowStyle">
             <div><span >身份证号:</span><span><input type="text" name="user.identify" value='${ugr.tbUser.identify }' id="user.identify"/></span></div>
         </div>
         <div class="rowStyle">
