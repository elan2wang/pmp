...
<input type="hidden" name="authority.authId" id="authority.authId" value="${authority.authId}"/>
       ...
       <div class="rowStyle">
           <div><span >管理权限:</span>                 
               ...
               <input type="radio" name="authority.issys" id="sys2" value="false" <c:if test="${authority.issys == false }">checked</c:if> /><label for="sys2">否</label>
               </span>
           </div>
       </div>
       <div class="rowStyle">
           ...
           <input type="button" value="取消" onclick="closeWindow('#editWindow')"/></div>
        </div>
</form>
</div>
</body>
