...
<form name="form3" id="form3" action="edit_auth_res" method="post">
	<input type="hidden" name="authID" id="authID" value="${authID}"/>
      ...
      <div class="middle">
      		<div class="rowStyle"><input  type="button" onclick="Add('#res_1','#resList');" value="添&nbsp;&nbsp;&nbsp;&nbsp;加" /></div>
			<div class="rowStyle"><input  type="button" onclick="Remove('#res_1','#resList');"  value="移&nbsp;&nbsp;&nbsp;&nbsp;除" /></div>
			<div class="rowStyle"><input  type="button" onclick="AddAll('#res_1','#resList')" value="全部添加"  /></div>
			<div class="rowStyle"><input  type="button" onclick="RemoveAll('#res_1','#resList');" value="全部移除"/></div>
      </div>
      <div class="right">
      ...
      <div class="rowStyle">
           ...
           <input type="button" value="取消" onclick="closeWindow('#auth_res')"/>
           </div>
      </div>
</form>
</div>
